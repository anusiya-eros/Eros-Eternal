...
import { Menu, X, SendHorizontal, Mic, Camera, ImagePlus, LogOut, SquarePlus, User, Upload, Play, Pause, Check, Plus } from "lucide-react";
...
>
  ...
  <div className="w-12 h-12 bg-cyan-500 rounded-full flex items-center justify-center text-sm font-semibold ml-2">
    A
  </div>
</div>
                </div>
